...
class EditComponent extends Component {
    ...
    state = {
        ...
        idAddress: this.props.customer.address.id,
        idCustomerContact: this.props.customer.contact.id,
        name: this.props.customer.name,
        line1: this.props.customer.address.line1,
        line2: this.props.customer.address.line2,
        websiteUrl: this.props.customer.address.websiteUrl,
        city: this.props.customer.address.city,
        province: this.props.customer.address.provice,
        country: this.props.customer.address.country,
        postalCode: this.props.customer.address.postalCode,
        registration: this.props.customer.registration,
        type: this.props.customer.type,
        firstName: this.props.customer.firtstName,
        lastName: this.props.customer.contact.lastName,
        email: this.props.customer.contact.email,
        officePhone: this.props.customer.contact.officePhone,
        mobie: this.props.customer.contact.mobie,
    }
    ...
    render() {
        return (
            <Container>
                <Row>
                    <Col xs="10">
                        <legend style={{ color: 'green' }}>Edit Customer</legend>
                    </Col>
                    <Col xs="2">
                        <ButtonToggle color="info" onClick={() => this.btnBackClick()}><ArrowLeftOutlined />Back</ButtonToggle>
                    </Col>
                </Row>
                <br />
                <Row>
