...
//    }
//
//    @GetMapping({"/getByIdInvoice/{id}"})
//    public ResponseEntity<InvoiceTotal> getByIdInvoice(@PathVariable(name = "id") int id){
//        return new ResponseEntity<>(invoiceTotalSer.getByIdInvoice(id), HttpStatus.OK);
//    }
//
